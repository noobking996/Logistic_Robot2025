...
RawMaterial_2_Processing_Stable=MissionDef_t("原料区->加工区(稳定)",MF.RawMaterial_2_Processing_Stable_Func,
                                             [[0,310,0],[0,0,890],[0,500,0],
                                              [MOVJ_Drection.Left_Forward,200,84],[0,500,0]],
                                              [1.5,2.5,3.2,1.05,1.1],True)
...
Partial_MIssion_Test=MissionManager([RawMaterial_Pos_Correction,RawMaterial_2_Processing_Stable],[[0,0,0]],True,0)

#####################################################################################

# 任务代号
Mission_Code="debug_0328_1522"
...
MF.RM.ProcessPutFetch_Yaw_Comp=1.5  # 加工区放置/回收专用的yaw轴误差补偿<deg>(在全局补偿的基础上)
...
blue_stuff=myObject("circle",myVideo,[(200,20,20),(255,180,190)],
                   [(176.46-x_delta,82.28-y_delta,-61+stuff_claw_height),
                    public_material_pos,
                    (150+7,-public_processing_distance-8,stuff_claw_height-arm_height)],
                    stuff_radius_range)
...
red_stuff=myObject("circle",myVideo,[(70,60,180),(255,180,255)],
                  [(176.46-x_delta,-82.28-y_delta_minus,-61+stuff_claw_height),
                   public_material_pos,
                   (-150,-public_processing_distance-1,stuff_claw_height-arm_height)],
                   stuff_radius_range)
